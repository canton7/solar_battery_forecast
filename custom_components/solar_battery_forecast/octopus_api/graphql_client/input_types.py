...
class TypedSourceInputType(BaseModel):
    utility: Optional[UtilityType] = None
...
class RegisterHeatPumpInput(BaseModel):
    account_number: str = Field(alias="accountNumber")
    property_id: Optional[int] = Field(alias="propertyId", default=None)
...
class ChargePointInput(BaseModel):
    charge_point_id: Optional[str] = Field(alias="chargePointId", default=None)
...
class ChargeCarbonOffsetInput(BaseModel):
    ...
    transport_mode_sub_code: Optional[str] = Field(
        alias="transportModeSubCode", default=None
    )
...
class CreateEVChargersLeadInput(BaseModel):
    ...
    property_profile: Optional["PropertyProfileInput"] = Field(
        alias="propertyProfile", default=None
    )
...
class PropertyProfileInput(BaseModel):
    installed_appliances: Optional["InstalledAppliancesInput"] = Field(
        alias="installedAppliances", default=None
    )
    off_street_parking: Optional[YesNoAnswer] = Field(
        alias="offStreetParking", default=None
    )
    live_rented_accommodation: Optional[YesNoAnswer] = Field(
        alias="liveRentedAccommodation", default=None
    )
    meter_location: Optional[MeterLocationChoices] = Field(
        alias="meterLocation", default=None
    )
    meter_location_not_listed: Optional[str] = Field(
        alias="meterLocationNotListed", default=None
    )
    distance_from_meter_to_charge_point: Optional[
        DistanceFromMeterToChargePointChoices
    ] = Field(alias="distanceFromMeterToChargePoint", default=None)
    cable_from_meter_to_charge_point_outside: Optional[
        CableFromMeterToChargePointChoices
    ] = Field(alias="cableFromMeterToChargePointOutside", default=None)
    cable_from_meter_to_charge_point_inside: Optional[
        CableFromMeterToChargePointChoices
    ] = Field(alias="cableFromMeterToChargePointInside", default=None)
    charge_point_installation_place: Optional[ChargePointInstallationChoices] = Field(
        alias="chargePointInstallationPlace", default=None
    )
    charge_point_installation_place_not_listed: Optional[str] = Field(
        alias="chargePointInstallationPlaceNotListed", default=None
    )
    black_box_meter_amp: Optional[BlackBoxMeterAmpChoices] = Field(
        alias="blackBoxMeterAmp", default=None
    )
    people_living_at_your_property: Optional[int] = Field(
        alias="peopleLivingAtYourProperty", default=None
    )
    three_phase_meter: Optional[YesNoIDontKnowAnswer] = Field(
        alias="threePhaseMeter", default=None
    )
    relevant_property_info: Optional[str] = Field(
        alias="relevantPropertyInfo", default=None
    )


class InstalledAppliancesInput(BaseModel):
    induction_hob: Optional[bool] = Field(alias="inductionHob", default=None)
    electric_oven: Optional[bool] = Field(alias="electricOven", default=None)
    immersion_heater: Optional[bool] = Field(alias="immersionHeater", default=None)
    electric_showers: Optional[bool] = Field(alias="electricShowers", default=None)
    electric_heater: Optional[bool] = Field(alias="electricHeater", default=None)
    electric_boiler: Optional[bool] = Field(alias="electricBoiler", default=None)
    led_lightning: Optional[bool] = Field(alias="ledLightning", default=None)
    jacuzzi_hottub_sauna: Optional[bool] = Field(
        alias="jacuzziHottubSauna", default=None
    )
    existing_fast_ev_charge_point_in_use: Optional[bool] = Field(
        alias="existingFastEvChargePointInUse", default=None
    )
    solar_panels: Optional[bool] = Field(alias="solarPanels", default=None)
    heat_pump: Optional[bool] = Field(alias="heatPump", default=None)
    battery_storage: Optional[bool] = Field(alias="batteryStorage", default=None)

...
class AccountQueryAccountElectricityAgreementsTariffFourRateEvTariff(BaseModel):
    typename__: Literal["FourRateEvTariff"] = Field(alias="__typename")
...
AccountQuery.model_rebuild()
AccountQueryAccount.model_rebuild()
AccountQueryAccountElectricityAgreements.model_rebuild()
AccountQueryAccountElectricityAgreementsTariffHalfHourlyTariff.model_rebuild()
AccountQueryAccountElectricityAgreementsMeterPoint.model_rebuild()
AccountQueryAccountElectricityAgreementsMeterPointMeters.model_rebuild()
